...
UBUNTU_TRANSLATION_DOMAIN="dialer.liu-xiao-guo"
...
aptest.commands = bash $$PWD/dialer/tests/autopilot/run
aptest.depends  = sub-dialer

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/dialer/tests/unit 
unittest.depends  = sub-dialer
